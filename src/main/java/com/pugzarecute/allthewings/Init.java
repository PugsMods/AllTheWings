...
public class Init {
    ...
    public static final RegistryObject<Item> YOUR_BEING_WATCHED_ELYTRA = ITEMS.register("your_being_watched_elytra",() -> new ElytraBase(new Item.Properties().durability(432).tab(ItemGroup.TAB_MISC)));
